# Reversa KOS
<small>Knowledge Operating System — built on top of <a href="https://github.com/sandeco/reversa">Reversa by sandeco</a></small>

> **Proveniência:** este repositório é um fork de [`sandeco/reversa`](https://github.com/sandeco/reversa)
> (o instalador multi-engine, os agentes/skills e o pipeline Discovery/Forward/Migrate/Docs originais
> são dele). A partir daqui, **Reversa KOS** — o motor de conhecimento (`lib/core/`), o sistema de
> plugins, o Studio de visualização e a spec KOS (`docs/KOS-*.md`) — é uma extensão própria de
> Roberto / IAgência AI. Créditos e licença MIT do projeto original preservados em [LICENSE](./LICENSE).

**Turn legacy systems into executable specifications for AI agents.**

> 📄 **Paper (projeto original):** [Reversa: A Reverse Documentation Engineering Framework for Converting Legacy Software into Operational Specifications for AI Agents](https://arxiv.org/abs/2605.18684) — Macedo & da Costa, May 2026.
